...
**结构模板 (以“人工智能”为例):**
- 第1步 (INFO): 核心概念：它是什么？ (用 2～3 个简短类比或定义说明核心思想)
- 第2步 (CAPACITY): 关键能力：它能做什么？ (列出 3 张能力卡片，每张包含名称与示例)
- 第3步 (PROCESS): 工作原理：它是如何工作的？ (用 4 个编号步骤描述简化流程)
- 第4步 (TYPES): 主要类型：有哪些不同种类？ (介绍2-3种常见的类型或分类)
- 第5步 (LEARN): 学习方式：它如何进步？ (3 个要点说明它的学习或训练方式)
- 第6步 (TOOLS): 关键技术：涉及哪些技术？ (列出 4～5 个关键技术并总结它们的作用)
- 第7步 (LIFE): 现实应用：它被用在哪里？ (举例说明 3～5 个现实生活场景)
